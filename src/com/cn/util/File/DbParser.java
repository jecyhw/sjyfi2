...
public class DbParser extends BaseFileParse{
    ...
    String url;// = "jdbc:mysql://159.226.15.215:3306/sjyfi_db?zeroDateTimeBehavior=convertToNull&allowMultiQueries=true&characterEncoding=utf8&autoReconnect=true";
    ...
    protected DbParser() {
        parseFileUri = this.getClass().getResource("/").getPath() + "configfile/db.xml";
    }
    @Override
